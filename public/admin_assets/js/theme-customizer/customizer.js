if(localStorage.getItem("color"))
    $("#color" ).attr("href", "{{asset('admin_assets/css/"+localStorage.getItem("color")+".css')}}" );
...
$(document).ready(function () {
      $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", "{{asset('admin_assets/css/"+color+".css')}}" );
    ...
    $('.sidebar-type li').on('click', function () {
        ...
        switch (type) {
            ...
            case 'normal-sidebar': {
                ...
                $(".logo-wrapper").find('img').attr('src', "{{asset('admin_assets/images/logo/logo.png')}}");
